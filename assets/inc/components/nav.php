...
<header class="container-fluid bg-dark navbar-light nav-header">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <span class="icon email float-end"><a
                        href="mailto:info@robustittraining.com">info@robustittraining.com</a></span>
                <span class="icon phone float-end"><a href="tel:02038757827">02038 757 827 </a></span>
            </div>
        </div>
    </div>
</header>
